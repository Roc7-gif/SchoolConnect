...
class Parent(models.Model):
    ...
    class Meta:
        ...
        constraints = [
            # Un numéro identifie un parent au sein d'une école. La condition est
            # indispensable : le téléphone peut être vide, et plusieurs fiches sans
            # numéro se télescoperaient sur une contrainte inconditionnelle.
